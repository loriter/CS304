...
<tr><td>Username</td><td><input type="text" size=30 name="new_cid"</td></tr>
<tr><td>Password</td><td><input type="text" size=30 name="new_pass"</td></tr>
<tr><td>Name</td><td><input type="text" size=30 name="new_name"</td></tr>
<tr><td>Address</td><td><input type="text" size=30 name="new_add"</td></tr>
