...
<?php
    ...
    /****************************************************
     ...
     2) by clicking the Delete link beside an item, or
     3) by clicking the bottom Submit button to add an item
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (isset($_POST["submitDelete"]) && $_POST["submitDelete"] == "DELETE") {
       ...
       /*
        Add an using the post variables upc, title, type, category, company, year, price, stock
        */
        $upc = $_POST["new_upc"];
